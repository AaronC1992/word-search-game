/**
 * QuickPlayUI - Controls quick play setup screen
 */
class QuickPlayUI {
    constructor() {
        this.screen = document.getElementById('quickplay-screen');
    ...
    initializeButtons() {
        ...
        document.getElementById('start-quickplay-btn').addEventListener('click', () => {
            this.startQuickPlay();
        });
    ...
    updateGridSizeEstimate() {
        ...
        const estimateDiv = document.getElementById('grid-size-estimate');
     ...
     */
    startQuickPlay() {
        window.app.gameManager.startQuickPlay(this.selectedDifficulty, this.wordCount);
        this.hide();
